# Capítol 15. Creació d'estils amb Ionic
...
* *Tabs*: la navegació està gestionada per un conjunt de pestanyes (analitzat en el [capítol anterior](chapter14.md))
* Menú: la navegació està gestionada per un menú (analitzat en el [capítol anterior](chapter14.md))
